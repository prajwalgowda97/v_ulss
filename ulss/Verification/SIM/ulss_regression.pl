...
sub simulate_test 
{
  ...
  my ($test) = @_;
   {   
    ...
    {
      system("irun -access +rwc -f compile_list.f -svseed $seed +UVM_TESTNAME=$test  +define+UVM_REPORT_DISABLE_FILE_LINE -coverage all -covdut rate_limiter_16to4  -covworkdir /cov_work -covoverwrite -covfile ./cov_files/cov_cmd.cf -uvmhome CDNS-1.1d"); 
    }
    else
    {  
